...
public class AgentReceiver3 : MonoBehaviour {
    ...
    {
        state = 0;
        patrol_start = new Vector3(1433f, 8.9f, 1312f);
        patrol_end = new Vector3(1433f, 8.9f, 1320f);
        neutral_pos = new Vector3(1434, 8.9f, 1312.7f);
        block_door = new Vector3(1423, 8.9f, 1317);
